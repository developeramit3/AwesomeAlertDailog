...
public class AwesomeDialog {
    ...
    public AwesomeDialog(Context context, String title, String subtitle, boolean bold, Typeface typeFace, boolean cancelable) {
        negativeExist=false;
    ...
    public void setPositive(String okLabel, mDialogClickListener listener) {
        this.positiveListener = listener;
        this.dismiss();
        setPositiveLabel(okLabel);
    }
    public void setNegative(String koLabel, mDialogClickListener listener) {
        if (listener != null){
        ...
        dialogButtonOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (positiveListener != null) {
                    positiveListener.onClick(AwesomeDialog.this);
                }
            }
        });
        dialogButtonNo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (negativeListener != null) {
                    negativeListener.onClick(AwesomeDialog.this);
                }
            }
        });
    }
